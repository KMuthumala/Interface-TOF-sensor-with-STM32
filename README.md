...
This is a edited version of the arduino library provided by the Pololu manufacturers. [VL53L0X time-of-flight distance sensor](https://github.com/pololu/vl53l0x-arduino)
The original Arduino library can be found at here.
## Supported platforms
